                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                              <a class="nav-link" href="{{route('fellows-assigned')}}">Fellows Assigned</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link active" href="{{route('signed-fellows')}}">Signed Fellows</a>
                            </li>
                          </ul>
                              ...
                              <tbody>
                                @foreach($appointmentData as $key => $value)
                                    <tr data-key={{$key+1}}>
                                        ...
                                        <td height="30">{{$value->aimz_remarks}}</td>
                                        <td height="30">{{$value->advisor_remarks}}</td>
                                        <td height="30">
                                            @if ($value->accepted == 1)
                                              Accepted
                                        ...
                                        <td height="30">{{$value->reason_for_rejection}}</td>
                                        <td height="30">
